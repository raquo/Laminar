...
trait Display extends None[String] { this: StyleProp[String] =>
  ...
  lazy val block: StyleSetter[String, String] = this := "block"

  /** The element generates one or more inline element boxes */
  lazy val inline: StyleSetter[String, String] = this := "inline"
  ...
  /**
    ...
    */
  lazy val flow: StyleSetter[String, String] = this := "flow"
  ...
  /**
    ...
    */
  lazy val flowRoot: StyleSetter[String, String] = this := "flow-root"

  /**
    * The element behaves like a block element and lays out its content according
    * to the flexbox model
    */
  lazy val flex: StyleSetter[String, String] = this := "flex"

  /**
    * The element behaves like a block element and lays out its content according
    * to the grid model
    */
  lazy val grid: StyleSetter[String, String] = this := "grid"
  ...
  /**
    ...
    * elements.
    */
  lazy val ruby: StyleSetter[String, String] = this := "ruby"
  ...
  /**
    ...
    */
  lazy val inlineBlock: StyleSetter[String, String] = this := "inline-block"

  /**
    * The element behaves like an inline element and lays out its content
    * according to the flexbox model
    */
  lazy val inlineFlex: StyleSetter[String, String] = this := "inline-flex"

  /**
    * The element behaves like an inline element and lays out its content
    * according to the grid model
    */
  lazy val inlineGrid: StyleSetter[String, String] = this := "inline-grid"
  ...
  /**
    ...
    */
  lazy val inlineTable: StyleSetter[String, String] = this := "inline-table"
  ...
  /**
    ...
    * inline box
    */
  lazy val listItem: StyleSetter[String, String] = this := "list-item"


  // -- Table --

  /** Behaves like the table HTML element. It defines a block-level box */
  lazy val table: StyleSetter[String, String] = this := "table"

  /** Behaves like the caption HTML element */
  lazy val tableCaption: StyleSetter[String, String] = this := "table-caption"

  /** Behaves like the td HTML element */
  lazy val tableCell: StyleSetter[String, String] = this := "table-cell"

  /** These elements behave like the corresponding col HTML elements */
  lazy val tableColumn: StyleSetter[String, String] = this := "table-column"

  /** These elements behave like the corresponding colgroup HTML elements */
  lazy val tableColumnGroup: StyleSetter[String, String] = this := "table-column-group"

  /** These elements behave like the corresponding tfoot HTML elements */
  lazy val tableFooterGroup: StyleSetter[String, String] = this := "table-footer-group"

  /** These elements behave like the corresponding thead HTML elements */
  lazy val tableHeaderGroup: StyleSetter[String, String] = this := "table-header-group"

  /** Behaves like the tr HTML element */
  lazy val tableRow: StyleSetter[String, String] = this := "table-row"

  /** These elements behave like the corresponding tbody HTML elements */
  lazy val tableRowGroup: StyleSetter[String, String] = this := "table-row-group"
