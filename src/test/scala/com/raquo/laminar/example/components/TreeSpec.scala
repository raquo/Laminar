...
class TreeSpec extends UnitSpec {
  ...
  it("ChildNode.isDescendantOf") {
    ...
    ChildNode.isDescendantOf(node = el0.ref, ancestor = root.ref) shouldBe true
    ChildNode.isDescendantOf(node = el0.ref, ancestor = el10.ref) shouldBe false
    ChildNode.isDescendantOf(node = el10.ref, ancestor = root.ref) shouldBe false
    ...
    ChildNode.isDescendantOf(node = el0.ref, ancestor = otherRoot.ref) shouldBe false
    ChildNode.isDescendantOf(node = el0.ref, ancestor = otherEl.ref) shouldBe false

    el0.appendChild(el10)
    el0.appendChild(el11)

    ChildNode.isDescendantOf(node = el10.ref, ancestor = root.ref) shouldBe true
    ChildNode.isDescendantOf(node = el11.ref, ancestor = root.ref) shouldBe true
    ...
    ChildNode.isDescendantOf(node = el11.ref, ancestor = otherRoot.ref) shouldBe false
    ChildNode.isDescendantOf(node = el11.ref, ancestor = otherEl.ref) shouldBe false

    el10.appendChild(el2)

    ChildNode.isDescendantOf(node = el2.ref, root.ref) shouldBe true
    ...
    ChildNode.isDescendantOf(node = el2.ref, otherRoot.ref) shouldBe false
    ChildNode.isDescendantOf(node = el2.ref, otherEl.ref) shouldBe false

    el2.appendChild(el3)

    ChildNode.isDescendantOf(node = el3.ref, ancestor = root.ref) shouldBe true
    ...
    ChildNode.isDescendantOf(node = el3.ref, ancestor = otherRoot.ref) shouldBe false
    ...
    ChildNode.isDescendantOf(node = el3.ref, ancestor = root.ref) shouldBe false
