...
Similarly, Laminar can now render any `A` type for which there is an implicit instance of `RenderableText[A]` as if it was a string. This includes usages like `text <-- observableOfA`.
